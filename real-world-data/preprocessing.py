...
with open("brute-data/jester-data-1.csv", "r") as f:
	line = f.readline()
	while line:
...
with open('Jester-large.txt', 'w') as f:
...
with open('Jester-small.txt', 'w') as f:
...
with open("brute-data/u.data", "r") as f: # This is a tab separated list of user id | item id | rating | timestamp
	line = f.readline()
	while line:
