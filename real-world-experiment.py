...
plt.bar(x + 2*width/3, aggregates_time["ucb_ds2"], width/3, label='UCB-DS2', edgecolor='black', hatch="--", color="#413DE7")
plt.bar(x + width/3, aggregates_time["ucb_ds"], width/3, label='UCB-DS', edgecolor='black', hatch="//", color="#B75F31")
plt.bar(x , aggregates_time["ucb_d"], width/3, label='UCB-D', edgecolor='black', hatch="||", color="#22792E")
plt.bar(x - width/3, aggregates_time["ucb"], width/3, label='UCB', edgecolor='black', color="#F3AE32")
plt.yscale('log')
